...
func main() {
	...
	mc, err := mongo.Connect(c, options.Client().ApplyURI("mongodb://192.168.178.128:27017/coolcar?readPreference=primary&appname=mongodb-vscode%200.7.0&directConnection=true&ssl=false"))
	if err != nil {
		panic(err)
	}
