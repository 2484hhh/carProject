...
var cosAddr = flag.String("cos_addr", "https://coolcar-1307768051.cos.ap-guangzhou.myqcloud.com", "cos address")
var cosSecID = flag.String("cos_sec_id", "<cosSecID>", "cos secret id")
var cosSecKey = flag.String("cos_sec_key", "<cosSecKey>", "cos secret key")
